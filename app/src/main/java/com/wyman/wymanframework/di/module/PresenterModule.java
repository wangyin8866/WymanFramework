...
import com.wyman.wymanframework.ui.home.HomePresenter;
...
//    }
     ...
     */
    @Provides
    HomePresenter provideHomePresenter(Context mContext){
        return new HomePresenter(mContext);//HomePresenter构造方法需要参数。 有以上方法1，2
    }
