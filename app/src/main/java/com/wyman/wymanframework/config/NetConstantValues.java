package com.wyman.wymanframework.config;
...
public interface NetConstantValues {
    ...
    String CONTRACT_URL=BuildConfig.INTERFACE_CONTART;//http://hlwm-test.chinazyjr.net/html/
    /**
     * 公共
     */
    ...
    String GET_BANKS = "common/getBanksQuota";//银行卡列表
    ...
    String disclosure = "http://hlwm-test.chinazyjr.net/html/Agreement/bidplancontract.html";//详情1的借款协议
    String watch_old = "https://hlwm-dev.chinazyjr.net/?loginStatus";//检测到返回新版app
    String risk_testgl = "https://hlwm-test.chinazyjr.net/html/about/evaluating.html";//风险测评
    String back_old="http://192.168.4.117:8099/Index/juidLogin?juid=";//返回旧版
    String url_borrow="http://hlwm-test.chinazyjr.net/html/Agreement/loanService.html";//出借咨询服务协议
}
